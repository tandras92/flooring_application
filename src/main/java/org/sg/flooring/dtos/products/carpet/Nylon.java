...
public class Nylon extends Carpet {
    ...
    public Nylon(Patterns pattern, Colors color, Textures texture, String carpetColor, String carpetPattern, String carpetTexture, BigDecimal costPerSquareFt, BigDecimal laborCostPerSquareFt) {
